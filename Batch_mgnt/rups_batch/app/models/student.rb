class Student < ActiveRecord::Base
  ...
  has_many :batches
  attr_accessible :address, :alternate_mobile, :email, :enrollment_date, :first_name, :last_name, :middle_name, :mobile, :state, :city, :zip_code, :address_line1, :address_line2, :qualifies_with, :sponsor, :qualifies_with
